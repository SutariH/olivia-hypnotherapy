...
export default function Footer() {
  return (
    <footer className="bg-[#5390d9] text-[#F6FFF8] py-12">
      <div className="max-w-6xl mx-auto px-4">
        <div className="grid md:grid-cols-4 gap-8">
          <div>
            <h3 className="text-2xl font-bold text-[#CCE3DE] mb-4">Olivia Hypnotherapy</h3>
            <p className="text-[#EAF4F4]">
              Transform your life through the power of hypnotherapy
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link href="/" className="text-[#EAF4F4] hover:text-[#F6FFF8] transition-colors">
                  Home
                </Link>
              </li>
              <li>
                <Link href="/about" className="text-[#EAF4F4] hover:text-[#F6FFF8] transition-colors">
                  About
                </Link>
              </li>
              <li>
                <Link href="/services" className="text-[#EAF4F4] hover:text-[#F6FFF8] transition-colors">
                  Services
                </Link>
              </li>
              <li>
                <Link href="/contact" className="text-[#EAF4F4] hover:text-[#F6FFF8] transition-colors">
                  Contact
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-2 text-[#EAF4F4]">
          ...
          <div>
            ...
            <div className="flex space-x-4">
              <a href="#" className="text-[#EAF4F4] hover:text-[#F6FFF8] transition-colors">
        ...
        <div className="mt-8 pt-8 border-t border-[#A4C3B2] text-center text-[#EAF4F4]">
          <p>&copy; {new Date().getFullYear()} Olivia Hypnotherapy. All rights reserved.</p>
        </div>
      </div>
    </footer>
  )
